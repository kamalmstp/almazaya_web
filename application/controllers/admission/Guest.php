...
class Guest extends Admin_Controller {
	...
	private function validation() {
		...
		$val->set_rules('full_name', 'Nama', 'trim|required');
		$val->set_rules('address', 'Alamat', 'trim|required');
		$val->set_rules('phone', 'Nomor Telepon', 'trim|required');
		$val->set_rules('created_at', 'Tanggal', 'trim|required|min_length[10]|max_length[10]');
