...
var grid_fields = [
	...
	// { header:'Jenjang Pendidikan', renderer:'school_level' },
...
form_fields.push(
	...
	{ label:'Kelurahan / Desa', name:'village', placeholder:'Nama Desa' },
	...
	{ label:'Asal Sekolah', name:'prev_school', placeholder:'Asal Sekolah' },
	{ label:'Tahun Kelulusan', name:'graduation_year', placeholder:'Tahun Kelulusan' },
	...
	{ label:'Nama Ayah', name:'father_name', placeholder:'Nama Ayah' },
	...
	{ label:'Pekerjaan Ayah', name:'father_employment', type:'select', datasource:DS.Employments },
	...
	{ label:'Nama Ibu', name:'mother_name', placeholder:'Nama Ibu' },
	...
	{ label:'Pekerjaan Ibu', name:'mother_employment', type:'select', datasource:DS.Employments },
...
function admission_reports() {
	...
	$.post(_BASE_URL + 'admission/registrants/admission_reports', {}, function(response) {
		...
		var fileName = 'DATA-CALON-' + _STUDENT.toUpperCase() + '-BARU JENJANG SMA';
