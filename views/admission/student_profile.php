      ...
      <div class="col-md-2">
         <div class="box box-primary">
            <div class="box-body box-profile">
               ...
               <p class="text-muted text-center"><?=$student->address?></p>
            </div>
         </div>
      </div>
      <div class="col-md-10">
                  ...
                  <form class="form-horizontal">
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=$student->prev_school?></p>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=$student->graduation_year?></p>
                           </div>
                        </div>
